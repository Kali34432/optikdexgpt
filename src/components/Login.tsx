          ...
          <div className="bg-gray-800/50 backdrop-blur-sm border border-cyan-700/30 rounded-xl p-8">
            ...
            <form onSubmit={handle2FASubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-3 rounded-lg transition-all duration-200 shadow-lg hover:shadow-cyan-500/25"
              >
                Verify & Login
              </button>
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm border border-cyan-700/30 rounded-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-gray-700/50 border border-cyan-600/30 rounded-lg px-4 py-3 pl-12 pr-12 text-white placeholder-gray-400 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20"
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white font-semibold py-3 rounded-lg transition-all duration-200 shadow-lg hover:shadow-cyan-500/25"
            >
          ...
          <div className="mt-6 pt-6 border-t border-cyan-700/30">
            <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-cyan-400 font-medium text-sm">Enhanced Security</p>
